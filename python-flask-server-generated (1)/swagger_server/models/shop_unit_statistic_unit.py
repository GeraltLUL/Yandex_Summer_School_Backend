...
class ShopUnitStatisticUnit(Model):
    ...
    """
    def __init__(self, id: str=None, name: str=None, parent_id: str=None, type: ShopUnitType=None, price: int=None, _date: datetime=None):  # noqa: E501
    ...
    def _date(self) -> datetime:
        """Gets the _date of this ShopUnitStatisticUnit.

        Время последнего обновления элемента.  # noqa: E501

        :return: The _date of this ShopUnitStatisticUnit.
        :rtype: datetime
        """
        return self.__date
    ...
    def _date(self, _date: datetime):
        ...
        :param _date: The _date of this ShopUnitStatisticUnit.
        :type _date: datetime
        """
        if _date is None:
